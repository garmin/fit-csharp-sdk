...
namespace Dynastream.Fit
{
    ...
    public class MonitoringMesg : Mesg
    {
        ...
        ///<summary>
        /// Retrieves the Pushes field
        /// Comment: Wheelchair Pushes</summary>
        /// <returns>Returns nullable uint representing the Pushes field</returns>
        public uint? GetPushes()
        {
        ...
        /// Set Pushes field
        /// Comment: Wheelchair Pushes</summary>
        /// <param name="pushes_">Nullable field value to be set</param>
        public void SetPushes(uint? pushes_)
        {
            SetFieldValue(41, 0, pushes_, Fit.SubfieldIndexMainField);
        }
