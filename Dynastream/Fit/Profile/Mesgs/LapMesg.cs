...
namespace Dynastream.Fit
{
    ...
    public class LapMesg : Mesg
    {
        ...
        static class TotalCyclesSubfield
        {
            ...
            public static ushort TotalPushes = 2;
        ...
        public sealed class FieldDefNum
        {
            ...
            public const byte NecLat = 27;
            public const byte NecLong = 28;
            public const byte SwcLat = 29;
            public const byte SwcLong = 30;
            ...
            public const byte ActiveTime = 70;
            public const byte WktStepIndex = 71;
            public const byte AvgSwolf = 73;
            ...
            public const byte AvgStrokesPerLength = 90;
            ...
            public const byte FrontGearShiftCount = 96;
            public const byte RearGearShiftCount = 97;
            ...
            public const byte MetabolicCalories = 155;
            ...
            public const byte AvgGradeAdjustedSpeed = 161;
        ...
        /// Units: pushes
        /// Comment: total number of pushes in a lap</summary>
        ...
        {
            Object val = GetFieldValue(17, 0, AvgCadenceSubfield.AvgSwimmingCadence);
            if(val == null)
            {
                return null;
            }
        ...
        {
            SetFieldValue(17, 0, avgSwimmingCadence, AvgCadenceSubfield.AvgSwimmingCadence);
        }
        ...
        {
            Object val = GetFieldValue(17, 0, AvgCadenceSubfield.AvgPaddlesportCadence);
            if(val == null)
            {
                return null;
            }
        ...
        {
            SetFieldValue(17, 0, avgPaddlesportCadence, AvgCadenceSubfield.AvgPaddlesportCadence);
        }

        /// <summary>
        /// Retrieves the AvgPushCadence subfield
        /// Units: pushes/min
        /// Comment: average pushes per minute in a lap</summary>
        /// <returns>Nullable byte representing the AvgPushCadence subfield</returns>
        public byte? GetAvgPushCadence()
        {
            Object val = GetFieldValue(17, 0, AvgCadenceSubfield.AvgPushCadence);
            if(val == null)
            {
                return null;
            }
        ...
        {
            SetFieldValue(17, 0, avgPushCadence, AvgCadenceSubfield.AvgPushCadence);
        }
        ///<summary>
        ...
        {
            Object val = GetFieldValue(18, 0, MaxCadenceSubfield.MaxSwimmingCadence);
            if(val == null)
            {
                return null;
            }
        ...
        {
            SetFieldValue(18, 0, maxSwimmingCadence, MaxCadenceSubfield.MaxSwimmingCadence);
        }
        ...
        {
            Object val = GetFieldValue(18, 0, MaxCadenceSubfield.MaxPaddlesportCadence);
            if(val == null)
            {
                return null;
            }
        ...
        {
            SetFieldValue(18, 0, maxPaddlesportCadence, MaxCadenceSubfield.MaxPaddlesportCadence);
        }

        /// <summary>
        /// Retrieves the MaxPushCadence subfield
        /// Units: pushes/min
        /// Comment: max pushes per minute in a lap</summary>
        /// <returns>Nullable byte representing the MaxPushCadence subfield</returns>
        public byte? GetMaxPushCadence()
        {
            Object val = GetFieldValue(18, 0, MaxCadenceSubfield.MaxPushCadence);
            if(val == null)
            {
                return null;
            }
        ...
        {
            SetFieldValue(18, 0, maxPushCadence, MaxCadenceSubfield.MaxPushCadence);
        }
        ///<summary>
        ...
        {
            SetFieldValue(27, 0, necLat_, Fit.SubfieldIndexMainField);
        }
        ...
        {
            SetFieldValue(28, 0, necLong_, Fit.SubfieldIndexMainField);
        }
        ...
        {
            SetFieldValue(29, 0, swcLat_, Fit.SubfieldIndexMainField);
        }
        ...
        {
            SetFieldValue(30, 0, swcLong_, Fit.SubfieldIndexMainField);
        }
        ...
        {
            SetFieldValue(70, 0, activeTime_, Fit.SubfieldIndexMainField);
        }
        ...
        {
            SetFieldValue(73, 0, avgSwolf_, Fit.SubfieldIndexMainField);
        }
        ...
        {
            SetFieldValue(90, 0, avgStrokesPerLength_, Fit.SubfieldIndexMainField);
        }
        ...
        {
            SetFieldValue(96, 0, frontGearShiftCount_, Fit.SubfieldIndexMainField);
        }
        ...
        {
            SetFieldValue(97, 0, rearGearShiftCount_, Fit.SubfieldIndexMainField);
        }
        ...
        {
            SetFieldValue(155, 0, metabolicCalories_, Fit.SubfieldIndexMainField);
        }
        ...
        {
            Object val = GetFieldValue(161, 0, Fit.SubfieldIndexMainField);
            if(val == null)
            {
                return null;
            }
        ...
        {
            SetFieldValue(161, 0, avgGradeAdjustedSpeed_, Fit.SubfieldIndexMainField);
        }
