...
namespace Dynastream.Fit
{
    ...
    public class MesgBroadcaster
    {
        ...
        public event MesgEventHandler BatteryMesgEvent;
        ...
        public event MesgEventHandler SleepDisruptionSeverityPeriodMesgEvent;
        
        public event MesgEventHandler SleepDisruptionOvernightSeverityMesgEvent;
        
        public event MesgEventHandler NapEventMesgEvent;
        ...
        public void OnMesg(object sender, MesgEventArgs e)
        {
            ...
            case (ushort)MesgNum.Battery:
                if (BatteryMesgEvent != null)
                {
                    BatteryMesg batteryMesg = new BatteryMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = batteryMesg;
                    BatteryMesgEvent(sender, mesgEventArgs);
                }
                break;
            ...
            case (ushort)MesgNum.SleepDisruptionSeverityPeriod:
                if (SleepDisruptionSeverityPeriodMesgEvent != null)
                {
                    SleepDisruptionSeverityPeriodMesg sleepDisruptionSeverityPeriodMesg = new SleepDisruptionSeverityPeriodMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = sleepDisruptionSeverityPeriodMesg;
                    SleepDisruptionSeverityPeriodMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.SleepDisruptionOvernightSeverity:
                if (SleepDisruptionOvernightSeverityMesgEvent != null)
                {
                    SleepDisruptionOvernightSeverityMesg sleepDisruptionOvernightSeverityMesg = new SleepDisruptionOvernightSeverityMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = sleepDisruptionOvernightSeverityMesg;
                    SleepDisruptionOvernightSeverityMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.NapEvent:
                if (NapEventMesgEvent != null)
                {
                    NapEventMesg napEventMesg = new NapEventMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = napEventMesg;
                    NapEventMesgEvent(sender, mesgEventArgs);
                }
                break;
