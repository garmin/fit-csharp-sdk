        ...
        public void OnMesg(object sender, MesgEventArgs e)
        {
            switch (e.mesg.Num)
            {
                ...
                case (ushort)MesgNum.Battery:
                    FitMessages.batteryMesgs.Add(new BatteryMesg(e.mesg));
                    break;
                ...
                case (ushort)MesgNum.SleepDisruptionSeverityPeriod:
                    FitMessages.sleepDisruptionSeverityPeriodMesgs.Add(new SleepDisruptionSeverityPeriodMesg(e.mesg));
                    break;
                case (ushort)MesgNum.SleepDisruptionOvernightSeverity:
                    FitMessages.sleepDisruptionOvernightSeverityMesgs.Add(new SleepDisruptionOvernightSeverityMesg(e.mesg));
                    break;
                case (ushort)MesgNum.NapEvent:
                    FitMessages.napEventMesgs.Add(new NapEventMesg(e.mesg));
                    break;
