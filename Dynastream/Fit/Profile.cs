...
namespace Dynastream.Fit
{
    ...
    public static class Profile
    {
        ...
        private static Mesg CreateSessionMesg()
        {
            ...
            subfieldIndex = 0;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("TotalReps", 134, 1, 0, "reps"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(6, 20);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 62);
            subfieldIndex++;
            ...
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("TotalPushes", 134, 1, 0, "pushes"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 66);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 65);
            subfieldIndex++;
            fieldIndex++;
            ...
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 1);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AvgSwimmingCadence", 2, 1, 0, "strokes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 5);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AvgPaddlesportCadence", 2, 1, 0, "strokes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 15);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 37);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AvgPushCadence", 2, 1, 0, "pushes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 66);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 65);
            subfieldIndex++;
            fieldIndex++;
            ...
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 1);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("MaxSwimmingCadence", 2, 1, 0, "strokes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 5);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("MaxPaddlesportCadence", 2, 1, 0, "strokes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 15);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 37);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("MaxPushCadence", 2, 1, 0, "pushes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 66);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(5, 65);
            subfieldIndex++;
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("ActiveTime", 78, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStrokesPerLength", 79, 132, 10, 0, "strokes/length", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgSwolf", 80, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("NumSegmentLaps", 106, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("FrontGearShiftCount", 107, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("RearGearShiftCount", 108, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AvgGradeAdjustedSpeed", 211, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
        ...
        private static Mesg CreateLapMesg()
        {
            ...
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("TotalPushes", 134, 1, 0, "pushes"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(25, 66);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(25, 65);
            subfieldIndex++;
            fieldIndex++;
            newMesg.SetField(new Field("TotalCalories", 11, 132, 1, 0, "kcal", false, Type.Uint16));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("NecLat", 27, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("NecLong", 28, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("SwcLat", 29, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("SwcLong", 30, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("ActiveTime", 70, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("WktStepIndex", 71, 132, 1, 0, "", false, Type.MessageIndex));
            fieldIndex++;
            newMesg.SetField(new Field("AvgSwolf", 73, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AvgStrokesPerLength", 90, 132, 10, 0, "strokes / length", false, Type.Uint16));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("FrontGearShiftCount", 96, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("RearGearShiftCount", 97, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("MetabolicCalories", 155, 132, 1, 0, "kcal", false, Type.Uint16));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AvgGradeAdjustedSpeed", 161, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
        ...
        private static Mesg CreateLengthMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("MetabolicCalories", 26, 132, 1, 0, "kcal", false, Type.Uint16));
            fieldIndex++;
        ...
        private static Mesg CreateBatteryMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("Battery", MesgNum.Battery);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("Capacity", 2, 2, 1, 0, "%", false, Type.Uint8));
            fieldIndex++;
        ...
        private static Mesg CreateSplitMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("Sport", 11, 0, 1, 0, "", false, Type.Sport));
            fieldIndex++;
            newMesg.SetField(new Field("SubSport", 12, 0, 1, 0, "", false, Type.SubSport));
            fieldIndex++;
            ...
            newMesg.SetField(new Field("MaxHeartRate", 16, 2, 1, 0, "bpm", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("NecLat", 17, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("NecLong", 18, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("SwcLat", 19, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("SwcLong", 20, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AvgCadence", 29, 132, 128, 0, "rpm", false, Type.Uint16));
            subfieldIndex = 0;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AvgRunningCadence", 132, 128, 0, "strides/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 1);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AvgSwimmingCadence", 132, 128, 0, "strokes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 5);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AvgPaddlesportCadence", 132, 128, 0, "strokes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 15);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 37);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AvgPushCadence", 132, 1, 0, "pushes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 66);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 65);
            subfieldIndex++;
            fieldIndex++;
            newMesg.SetField(new Field("MaxCadence", 30, 132, 128, 0, "rpm", false, Type.Uint16));
            subfieldIndex = 0;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("MaxRunningCadence", 132, 128, 0, "strides/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 1);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("MaxSwimmingCadence", 132, 128, 0, "strokes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 5);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("MaxPaddlesportCadence", 132, 128, 0, "strokes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 15);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 37);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("MaxPushCadence", 132, 1, 0, "pushes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 66);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 65);
            subfieldIndex++;
            fieldIndex++;
            newMesg.SetField(new Field("TotalCycles", 31, 134, 1, 0, "cycles", false, Type.Uint32));
            subfieldIndex = 0;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("TotalStrides", 134, 1, 0, "strides"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 1);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 11);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("TotalStrokes", 134, 1, 0, "strokes"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 2);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 5);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 15);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 37);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("TotalReps", 134, 1, 0, "reps"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 62);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("TotalPushes", 134, 1, 0, "pushes"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 66);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 65);
            subfieldIndex++;
            fieldIndex++;
            newMesg.SetField(new Field("AvgTemperature", 32, 1, 1, 0, "C", false, Type.Sint8));
            fieldIndex++;
            newMesg.SetField(new Field("MaxTemperature", 33, 1, 1, 0, "C", false, Type.Sint8));
            fieldIndex++;
            newMesg.SetField(new Field("MinTemperature", 34, 1, 1, 0, "C", false, Type.Sint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgVerticalOscillation", 35, 132, 10, 0, "mm", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgVerticalRatio", 36, 132, 100, 0, "percent", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStanceTime", 37, 132, 10, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStanceTimeBalance", 38, 132, 100, 0, "percent", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStepLength", 39, 132, 10, 0, "mm", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgPower", 40, 132, 1, 0, "watts", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("MaxPower", 41, 132, 1, 0, "watts", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("NormalizedPower", 42, 132, 1, 0, "watts", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("LeftRightBalance", 43, 132, 1, 0, "", false, Type.LeftRightBalance100));
            fieldIndex++;
            newMesg.SetField(new Field("TimeStanding", 44, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPco", 45, 1, 1, 0, "mm", false, Type.Sint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPco", 46, 1, 1, 0, "mm", false, Type.Sint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPowerPhase", 47, 2, 0.7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPowerPhasePeak", 48, 2, 0.7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPowerPhase", 49, 2, 0.7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPowerPhasePeak", 50, 2, 0.7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgPowerPosition", 51, 132, 1, 0, "watts", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("MaxPowerPosition", 52, 132, 1, 0, "watts", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftTorqueEffectiveness", 53, 2, 2, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightTorqueEffectiveness", 54, 2, 2, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPedalSmoothness", 55, 2, 2, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPedalSmoothness", 56, 2, 2, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgCombinedPedalSmoothness", 57, 2, 2, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgFlow", 58, 136, 1, 0, "Flow", false, Type.Float32));
            fieldIndex++;
            newMesg.SetField(new Field("TotalGrit", 59, 136, 1, 0, "kGrit", false, Type.Float32));
            fieldIndex++;
            newMesg.SetField(new Field("SwimStroke", 62, 0, 1, 0, "", false, Type.SwimStroke));
            fieldIndex++;
            newMesg.SetField(new Field("NumActiveLengths", 63, 132, 1, 0, "lengths", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgSwolf", 64, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStrokeDistance", 65, 132, 100, 0, "m", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStrokesPerLength", 66, 132, 10, 0, "strokes / length", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("FirstLapIndex", 67, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("NumLaps", 68, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("ClimbGradingScale", 69, 0, 1, 0, "", false, Type.ClimbGradingScale));
            fieldIndex++;
            newMesg.SetField(new Field("ClimbGradeValue", 70, 134, 1, 0, "", false, Type.Uint32));
            subfieldIndex = 0;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbGradeYds", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(69, 0);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbGradeUiaa", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(69, 1);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbGradeFrench", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(69, 2);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbGradeBritishAdjectival", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(69, 3);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbGradeBritishTechnical", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(69, 4);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbGradeEwbank", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(69, 5);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbGradeBrazilian", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(69, 6);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbGradeSaxon", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(69, 7);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbGradeVermin", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(69, 8);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbGradeFont", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(69, 9);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbGradeDankyu", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(69, 10);
            subfieldIndex++;
            fieldIndex++;
            newMesg.SetField(new Field("Status", 71, 0, 1, 0, "", false, Type.SplitStatus));
            fieldIndex++;
            newMesg.SetField(new Field("NumFalls", 72, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("ClimbSend", 73, 0, 1, 0, "", false, Type.Bool));
            fieldIndex++;
            newMesg.SetField(new Field("StartElevation", 74, 134, 5, 500, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("ActiveTime", 78, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("MetabolicCalories", 79, 132, 1, 0, "kcal", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("TotalFractionalAscent", 80, 2, 100, 0, "m", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("TotalFractionalDescent", 81, 2, 100, 0, "m", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgGrade", 88, 131, 100, 0, "%", false, Type.Sint16));
            fieldIndex++;
            newMesg.SetField(new Field("MaxGrade", 89, 131, 100, 0, "%", false, Type.Sint16));
            fieldIndex++;
            newMesg.SetField(new Field("MinCadence", 90, 132, 128, 0, "rpm", false, Type.Uint16));
            subfieldIndex = 0;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("MinRunningCadence", 132, 128, 0, "strides/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 1);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("MinSwimmingCadence", 132, 128, 0, "strokes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 5);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("MinPaddlesportCadence", 132, 128, 0, "strokes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 15);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 37);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("MinPushCadence", 132, 1, 0, "pushes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 66);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(11, 65);
            subfieldIndex++;
            fieldIndex++;
            newMesg.SetField(new Field("AvgGradeAdjustedSpeed", 93, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStress", 94, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgVam", 99, 132, 1000, 0, "m/s", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("JumpCount", 104, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("TotalMovingTime", 110, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("DiveSectionType", 112, 0, 1, 0, "", false, Type.DiveSectionType));
            fieldIndex++;
            newMesg.SetField(new Field("AvgAscentRate", 113, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("MaxAscentRate", 114, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("AvgDescentRate", 115, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("MaxDescentRate", 116, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("TotalAscentTime", 117, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("TotalDescentTime", 118, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("TotalHangTime", 119, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("ApneaDiscipline", 120, 0, 1, 0, "", false, Type.ApneaDiscipline));
            fieldIndex++;
            newMesg.SetField(new Field("AvgDepth", 121, 134, 1000, 0, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("MaxDepth", 122, 134, 1000, 0, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("MinHeartRate", 124, 2, 1, 0, "bpm", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("SurfaceInterval", 127, 134, 1, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("TotalFractionalCycles", 142, 2, 128, 0, "cycles", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStanceTimePercent", 144, 132, 100, 0, "percent", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("TotalAnaerobicTrainingEffect", 168, 2, 10, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("FrontGearShiftCount", 169, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("RearGearShiftCount", 170, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
        ...
        private static Mesg CreateSplitSummaryMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AvgCadence", 14, 132, 128, 0, "rpm", false, Type.Uint16));
            subfieldIndex = 0;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AvgRunningCadence", 132, 128, 0, "strides/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 1);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AvgSwimmingCadence", 132, 128, 0, "strokes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 5);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AvgPaddlesportCadence", 132, 128, 0, "strokes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 15);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 37);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AvgPushCadence", 132, 1, 0, "pushes/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 66);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 65);
            subfieldIndex++;
            fieldIndex++;
            newMesg.SetField(new Field("MaxCadence", 15, 132, 128, 0, "rpm", false, Type.Uint16));
            subfieldIndex = 0;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("MaxRunningCadence", 132, 128, 0, "strides/min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 1);
            subfieldIndex++;
            ...
            subfieldIndex++;
            fieldIndex++;
            newMesg.SetField(new Field("TotalCycles", 16, 134, 1, 0, "cycles", false, Type.Uint32));
            subfieldIndex = 0;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("TotalStrides", 134, 1, 0, "strides"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 1);
            ...
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("TotalReps", 134, 1, 0, "reps"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 62);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("TotalPushes", 134, 1, 0, "pushes"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 66);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 65);
            subfieldIndex++;
            fieldIndex++;
            newMesg.SetField(new Field("AvgTemperature", 17, 1, 1, 0, "C", false, Type.Sint8));
            fieldIndex++;
            newMesg.SetField(new Field("MaxTemperature", 18, 1, 1, 0, "C", false, Type.Sint8));
            fieldIndex++;
            newMesg.SetField(new Field("MinTemperature", 19, 1, 1, 0, "C", false, Type.Sint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgVerticalOscillation", 20, 132, 10, 0, "mm", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgVerticalRatio", 21, 132, 100, 0, "percent", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStanceTime", 22, 132, 10, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStanceTimeBalance", 23, 132, 100, 0, "percent", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStepLength", 24, 132, 10, 0, "mm", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgPower", 25, 132, 1, 0, "watts", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("MaxPower", 26, 132, 1, 0, "watts", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("NormalizedPower", 27, 132, 1, 0, "watts", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("LeftRightBalance", 28, 132, 1, 0, "", false, Type.LeftRightBalance100));
            fieldIndex++;
            newMesg.SetField(new Field("TimeStanding", 29, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPco", 30, 1, 1, 0, "mm", false, Type.Sint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPco", 31, 1, 1, 0, "mm", false, Type.Sint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPowerPhase", 32, 2, 0.7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPowerPhasePeak", 33, 2, 0.7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPowerPhase", 34, 2, 0.7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPowerPhasePeak", 35, 2, 0.7111111, 0, "degrees", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgPowerPosition", 36, 132, 1, 0, "watts", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("MaxPowerPosition", 37, 132, 1, 0, "watts", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftTorqueEffectiveness", 38, 2, 2, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightTorqueEffectiveness", 39, 2, 2, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgLeftPedalSmoothness", 40, 2, 2, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRightPedalSmoothness", 41, 2, 2, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgCombinedPedalSmoothness", 42, 2, 2, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgFlow", 43, 136, 1, 0, "Flow", false, Type.Float32));
            fieldIndex++;
            newMesg.SetField(new Field("TotalGrit", 44, 136, 1, 0, "kGrit", false, Type.Float32));
            fieldIndex++;
            newMesg.SetField(new Field("SwimStroke", 47, 0, 1, 0, "", false, Type.SwimStroke));
            fieldIndex++;
            newMesg.SetField(new Field("NumActiveLengths", 48, 132, 1, 0, "lengths", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgSwolf", 49, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStrokeDistance", 50, 132, 100, 0, "m", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStrokesPerLength", 51, 132, 10, 0, "strokes / length", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgAscent", 52, 132, 1, 0, "m", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("MaxAscent", 53, 132, 1, 0, "m", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("ClimbGradingScale", 54, 0, 1, 0, "", false, Type.ClimbGradingScale));
            fieldIndex++;
            newMesg.SetField(new Field("ClimbMaxGradeValue", 55, 134, 1, 0, "", false, Type.Uint32));
            subfieldIndex = 0;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbMaxGradeYds", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(54, 0);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbMaxGradeUiaa", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(54, 1);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbMaxGradeFrench", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(54, 2);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbMaxGradeBritishAdjectival", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(54, 3);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbMaxGradeBritishTechnical", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(54, 4);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbMaxGradeEwbank", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(54, 5);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbMaxGradeBrazilian", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(54, 6);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbMaxGradeSaxon", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(54, 7);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbMaxGradeVermin", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(54, 8);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbMaxGradeFont", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(54, 9);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("ClimbMaxGradeDankyu", 0, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(54, 10);
            subfieldIndex++;
            fieldIndex++;
            newMesg.SetField(new Field("NumFalls", 56, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("NumClimbsAttempted", 58, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("NumClimbsCompleted", 59, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("MaxDistance", 60, 134, 100, 0, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("MetabolicCalories", 64, 132, 1, 0, "kcal", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("ActiveTime", 65, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("TotalFractionalAscent", 66, 2, 100, 0, "m", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("TotalFractionalDescent", 67, 2, 100, 0, "m", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgFractionalAscent", 68, 2, 100, 0, "m", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("MaxFractionalAscent", 69, 2, 100, 0, "m", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgGradeAdjustedSpeed", 71, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStress", 72, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("TotalMovingTime", 77, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("StartTime", 79, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("MinHeartRate", 87, 2, 1, 0, "bpm", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgStanceTimePercent", 91, 132, 100, 0, "percent", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("MaxTotalTimerTime", 101, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
        ...
        private static Mesg CreateSegmentLapMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("MetabolicCalories", 88, 132, 1, 0, "kcal", false, Type.Uint16));
            fieldIndex++;
        ...
        private static Mesg CreateMonitoringMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("Pushes", 41, 134, 1, 0, "", false, Type.Uint32));
            fieldIndex++;
        ...
        private static Mesg CreateHsaWristTemperatureDataMesg()
        {
            ...
            newMesg.SetField(new Field("ProcessingInterval", 0, 132, 1, 0, "s", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("Value", 1, 132, 1000, 0, "C", false, Type.Uint16));
            fieldIndex++;
